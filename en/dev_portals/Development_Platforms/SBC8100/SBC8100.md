...
Serial, RTC, Net, Flash, LCD, Touch screen, S-Video, TV out, VGA, Audio
In/Out, SD, USB Host, USB OTG, Keypad, WiFi, GPS, LED
...
显示驱动（S-Video,AV, TFT LCD）

Serial, RTC, Net, Flash, LCD, Touch screen, S-Video, TV out, VGA, Audio
In/Out, SD, USB OTG, USB Host, Keypad, WiFi/BT, GPS, LED, VRFB,
DSPLINKK/CMEMK, PWM, ADC, GPIO/I2C/SPI/MCBSP
