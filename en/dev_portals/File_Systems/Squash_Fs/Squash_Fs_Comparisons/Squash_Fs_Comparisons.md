> From: [eLinux.org](http://eLinux.org/Squash_Fs_Comparisons "http://eLinux.org/Squash_Fs_Comparisons")
...
The following performance tests were based on two file sets: the liveCD
