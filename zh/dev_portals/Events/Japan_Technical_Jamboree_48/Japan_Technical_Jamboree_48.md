> From: [eLinux.org](http://eLinux.org/Japan_Technical_Jamboree_48 "http://eLinux.org/Japan_Technical_Jamboree_48")
...
Reports the first impression of A64 instruction set and execute them
using QEMU.
